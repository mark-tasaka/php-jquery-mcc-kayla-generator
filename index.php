...
<html>
<head>
<title>Launch Page: Kayla Character Generator</title>
...
<body>
	...
	<section>
        ...
        <br/>
            ...
            <br/>    
			<form action="" id ="kaylaForm"  target="_blank" method="post">
		...
		<div class="content8">
			  ...
			  <select id="level" class="dropdownmenu2Iconic">
				<option value="01" selected>Kayla, Level 1</option>
				<option value="02">Kayla, Level 2</option>
				<option value="03">Kayla, Level 3</option>
				<option value="04">Kayla, Level 4</option>
				<option value="05">Kayla, Level 5</option>
				<option value="06">Kayla, Level 6</option>
				<option value="07">Kayla, Level 7</option>
				<option value="08">Kayla, Level 8</option>
				<option value="09">Kayla, Level 9</option>
				<option value="10">Kayla, Level 10</option>
			  </select>
        ...
        {
            $("#kaylaForm").attr('action', "kayla/kayla"+ $("#level").val() +  ".php");
        });
